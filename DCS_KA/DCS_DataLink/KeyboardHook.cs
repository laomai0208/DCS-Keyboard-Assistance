...
namespace DCS_DataLink
{
    ...
    class KeyboardHook
    {
        ...
        /// <summary>
        /// 六个bool值分别对应上下左右pgup和pgdn的按压情况
        /// </summary>
        public bool[] ctrlKeyDown = new bool[6];

        public int[] ctrlKeySettings = new int[6];
        ...
        public void Start()
        {
            ...
            if (hKeyboardHook == 0)
            {
                ...
                hKeyboardHook = SetWindowsHookEx(13, KeyboardHookProcedure, GetModuleHandle(System.Diagnostics.Process.GetCurrentProcess().MainModule.ModuleName), 0);
        ...
        private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
        {
            ...
            if ((nCode >= 0) && (KeyDownEvent != null || KeyUpEvent != null || KeyPressEvent != null))
            {
                ...
                if (KeyDownEvent != null && (wParam == WM_KEYDOWN || wParam == WM_SYSKEYDOWN))
                {
                    ...
                    keyDown[MyKeyboardHookStruct.vkCode] = true;
                ...
                if (KeyUpEvent != null && (wParam == WM_KEYUP || wParam == WM_SYSKEYUP))
                {
                    ...
                    keyDown[MyKeyboardHookStruct.vkCode] = false;
